//package com.md.tournament.util;
//
...
//
//    private static final String SECRET_KEY = "secret-key-secret-key-secret-key-secret-key";
//
...
//        claims.put("userType", user.getRole().toString());
